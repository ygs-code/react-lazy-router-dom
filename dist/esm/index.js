...
import React, { Children, cloneElement, createElement, Component, createContext } from 'react';
...
var Route=function Route(props){var children=props.children;return children?Children.map(children,function(child){return/*#__PURE__*/cloneElement(child,props);}):null;};Route.propTypes={//   key: PropTypes.string.isRequired,
...
function _createSuper$1(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct$1();return function _createSuperInternal(){var Super=_getPrototypeOf(Derived),result;if(hasNativeReflectConstruct){var NewTarget=_getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget);}else {result=Super.apply(this,arguments);}return _possibleConstructorReturn(this,result);};}function _isNativeReflectConstruct$1(){if(typeof Reflect==="undefined"||!Reflect.construct)return false;if(Reflect.construct.sham)return false;if(typeof Proxy==="function")return true;try{Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){}));return true;}catch(e){return false;}}var createNamedContext=function createNamedContext(name){var context=/*#__PURE__*/createContext();context.displayName=name;return context;};var MatchContext=createNamedContext("Router-Match");// const isValidElement = (object) => {
...
export { MatchContext, Route, Router, Switch, RouterContext as __RouterContext, isValidElementType, lazy, matchPath, preloadReady, withRouter };
